		...
		<>
			...
			<main className="relative mx-3 my-4 flex flex-col justify-start overflow-y-auto rounded-3xl border border-white/10 bg-white/5 shadow-md sm:mx-6">
				...
				<div className="relative p-4 sm:p-6 md:p-10">
					<Suspense
						fallback={
							<div className="mx-auto flex min-h-[55vh] w-full max-w-xl flex-col items-center justify-center gap-4 text-center">
								<div className="h-12 w-12 rounded-2xl bg-gradient-to-r from-accent-cyan via-accent-purple to-accent-pink opacity-70 shadow-glow" />
